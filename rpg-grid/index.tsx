...
import { resolveRelative, FullSlug, simplifySlug, SimpleSlug } from "@quartz-community/utils"
...
// -----------------------------------------------------------------------
// v5 native piece: register the "index-only" condition once. Any other
// homepage-only component (GardenSection, BookGrid) can reference
// `condition: index-only` in its own YAML layout block without
// re-registering this function. This replaces the `isHome` slug check
// that used to live inline in quartz.layout.tsx.
// -----------------------------------------------------------------------
export function init() {
  registerCondition("index-only", (props: QuartzComponentProps) => {
